...
// func DailyCrashRate(job *job.Job, f *gotelemetry.Flow) {

// 	if data, err := f.ValueData(); err == nil {
// 		// Build the Request of Crittercism
// 		params := fmt.Sprintf(`{"params":{"graph": "crashPercent", "value_type": "percent", "duration": 1440, "appId": "%s"}}`, job.Config()["appId"])
